...
For C#/.NET, you can get the official MySql.Data package 
by executing command inside of the project
Terminal:   dotnet add package MySql.Data */
using MySql.Data;
using MySql.Data.MySqlClient;

namespace Practical_Assignment_Databases
{
    class Program
    {
        static void Main(string[] args)
        {
            /*прописываем всю информацию подключения о компе и пароль,но перед этим
            прописываем в MySQL connecting*/
            string connString = "server=localhost;port=3306;database=WebShop;user=new2user;password=FRISTAD1969";
            ...
            cmd = new MySqlCommand(@"
            INSERT INTO Products (`name`, `description`, price, warrantyPeriod, categoryId, suppliersId) VALUES
            ...
            //Count average s rezuljtatom (decimal)cmd.ExecuteScalar()
